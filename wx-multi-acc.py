...
def ticket_success(hzmbus, oheaders, orderNo, oReqNo):
    ...
    if info.get("autopay", False):
        ...
        """while True:
            try:
                homepage = hzmbus.post("https://wx.hzmbus.com/webapi/manage/get.payment.type.info", headers=headers, json={
                    "appId": "HZMBWEB_HK",
                    "currency": "2",
                    "joinType": "WEB",
        ...
        while True:
            try:
                homepage = hzmbus.post("https://wx.hzmbus.com/webapi/wx/query.wx.order.payreq", headers=headers, json={
                    "orderNo": orderNo,
                    "payType": MASTERCARD,
                    "language":"lang-zh",
                    "feeType":9,
